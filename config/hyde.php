...
return [
    ...
    */
    ...
    'name' => env('SITE_NAME', 'Hagenberg Game Jam'),
    ...
    */
    ...
    'rss' => [
        ...
        'description' => (is_string($v = env('SITE_NAME', 'HydePHP')) ? $v : 'HydePHP') . ' RSS Feed',
    ],
    ...
    */
    ...
    'meta' => [
        ...
        Meta::property('site_name', is_string($sn = env('SITE_NAME', 'Hagenberg Game Jam')) ? $sn : 'Hagenberg Game Jam'),
    ],
    ...
    */
    ...
    'navigation' => [
        ...
        'exclude' => [
            ...
            'people',            '2025',            '2014',            '2013',            '2012',            '2011',
        ...
        'custom' => [
            // Archive dropdown will be handled automatically via subdirectory_display: 'dropdown'
            // Individual archive pages will be added automatically when they exist
        ],
    ...
    */
    ...
    // webmanifest is needed so site.webmanifest is copied to _site/media/ for PWA manifest support.
