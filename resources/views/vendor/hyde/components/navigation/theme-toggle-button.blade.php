@if(Features::hasDarkmode() && Features::hasThemeToggleButtons())
    <button type="button" onclick="toggleTheme()" {{ $attributes->merge(['class' => 'theme-toggle-button flex items-center px-2 py-1 hover:text-gray-700 dark:text-gray-200']) }} title="Toggle theme">
